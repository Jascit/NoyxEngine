...
{
public:
    explicit VMAAdapter(T *allocator)
    ...
    FORCE_INLINE void *allocate(uint64_t size) override { return m_allocator->allocate(size); }
...
public:
    ...
    public:
        ...
        public:
            ...
            void set_range(void *base, void *ptr, std::size_t count, bool value) noexcept;

            [[nodiscard]] std::size_t granularity() const noexcept { return m_granularity; }

            [[nodiscard]] std::size_t page_count() const noexcept { return m_bitmap.size() * 64u; }
