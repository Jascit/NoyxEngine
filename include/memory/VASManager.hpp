...
public:
    ...
    FORCE_INLINE void *base() noexcept { return m_base; }

    FORCE_INLINE uint64_t size() noexcept { return m_size; }

    FORCE_INLINE uint64_t free_bytes() noexcept { return m_size - m_offset; } // void* -> uint64_t
