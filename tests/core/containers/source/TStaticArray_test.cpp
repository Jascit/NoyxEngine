...
NOYX_TEST(tstaticarray_move_only, unit_test)
{
    ...
    NOYX_ASSERT_TRUE(arr[(TStaticArray<UP, 3>::size_type) 0] &&
                     *arr[(TStaticArray<UP, 3>::size_type) 0] == 5);
    NOYX_ASSERT_TRUE(arr[(TStaticArray<UP, 3>::size_type) 1] &&
                     *arr[(TStaticArray<UP, 3>::size_type) 1] == 7);
}
