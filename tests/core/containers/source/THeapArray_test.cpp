...
NOYX_TEST(heap_array_test, non_trivial_lifetime_counts) {
  ...
  struct Tracer {
    ...
    Tracer(Tracer&& o) noexcept : _live(o._live) {
...
NOYX_TEST(heap_array_test, value_constructor_nontrivial) {
  ...
  struct Tracer2 {
    ...
    Tracer2(std::atomic<int>* l = nullptr, std::atomic<int>* c = nullptr, std::atomic<int>* m = nullptr
            , int p = 0) noexcept
...
NOYX_TEST(heap_array_test, resize_destroys_elements) {
  ...
  struct R {
    ...
    R(R&& o) noexcept : _live(o._live), tag(o.tag) {
      if (_live) _live->fetch_add(1);
      o._live = nullptr;
    }
...
NOYX_TEST(heap_array_test, swap_preserves_resources) {
  ...
  struct Resource {
    ...
    Resource(Resource&& o) noexcept : _live(o._live), id(o.id) {
      if (_live) _live->fetch_add(1);
      o._live = nullptr;
    }
