...
struct TestTypeInvokerHasPostIncrement {
  void operator()() const {
    ...
    tt_has_post_increment_test_value<double, true>();
    tt_has_post_increment_test_value<const int, false>(); 

    tt_has_post_increment_test_value<A, true>();
    tt_has_post_increment_test_value<B, false>();
    tt_has_post_increment_test_value<C, true>(); 
    tt_has_post_increment_test_value<D, true>();
    tt_has_post_increment_test_value<E, true>();
    tt_has_post_increment_test_value<F, false>(); 

    tt_has_post_increment_test_value<int[3], false>();
    tt_has_post_increment_test_value<void, false>();
  }
};
